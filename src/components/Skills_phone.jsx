...
export default function Skills_phone() {
  const languages = [
    ...
    "https://cdn.jsdelivr.net/npm/@programming-languages-logos/php@0.0.0/php_256x256.png"
  ];
  const frontend = [
  ...
  const backend = [
    ...
    "https://cdn.jsdelivr.net/npm/aws-icons@3.0.0/icons/architecture-group/AWSCloudlogo.svg"
  ];
  return (
    <div>
